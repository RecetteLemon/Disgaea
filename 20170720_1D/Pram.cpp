...
void Pram::posSet(void)
{
	...
	int arrSKILL[] = { 130,131,132,133,134 };
	_player.pos[PLAYER_POS_LB_SKILL]->setPlayFrame(arrSKILL, 5, 0);
	_player.pos[PLAYER_POS_LB_SKILL]->setFPS(10);

}


void Pram::release(void)								  
{
}
void Pram::update(void)									  
{
	player::update();
}
void Pram::render(void)									  
{
	player::render();
}
