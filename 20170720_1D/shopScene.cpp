	...
	case 1:
		...
		for (int i = _changeNum; i < 8 + _changeNum; i++)
		{
			...
			if (_isBuyInfo)
			{
				...
				DIRECT2D->drawTextD2D(DIRECT2D->createBrush(RGB(0x00, 0x00, 0x00), 1), L"고딕", 30, str, 63 + 330 - wcslen(str), WINSIZEY - 117 + 100, 63 + 330 + 1, 523 + 100 + 50);

				swprintf_s(str, L"%d", _item->getVItem()[_buySlotNum + (int)_buySlot].SP);
				DIRECT2D->drawTextD2D(DIRECT2D->createBrush(RGB(0x00, 0x00, 0x00), 1), L"고딕", 30, str, 63 + 330 - wcslen(str), WINSIZEY - 117 + 130, 63 + 330 + 1, 523 + 130 + 50);

				swprintf_s(str, L"%d", _item->getVItem()[_buySlotNum + (int)_buySlot].Atk);
				DIRECT2D->drawTextD2D(DIRECT2D->createBrush(RGB(0x00, 0x00, 0x00), 1), L"고딕", 30, str, 63 + 330 - wcslen(str), WINSIZEY - 117 + 165, 63 + 330 + 1, 523 + 165 + 50);

				swprintf_s(str, L"%d", _item->getVItem()[_buySlotNum + (int)_buySlot].Int);
				DIRECT2D->drawTextD2D(DIRECT2D->createBrush(RGB(0x00, 0x00, 0x00), 1), L"고딕", 30, str, 63 + 330 - wcslen(str), WINSIZEY - 117 + 195, 63 + 330 + 1, 523 + 195 + 50);

				swprintf_s(str, L"%d", _item->getVItem()[_buySlotNum + (int)_buySlot].Def);
				DIRECT2D->drawTextD2D(DIRECT2D->createBrush(RGB(0x00, 0x00, 0x00), 1), L"고딕", 30, str, 63 + 665 - wcslen(str), WINSIZEY - 117 + 165, 63 + 665 + 1, 523 + 165 + 50);

				swprintf_s(str, L"%d", _item->getVItem()[_buySlotNum + (int)_buySlot].Res);
				DIRECT2D->drawTextD2D(DIRECT2D->createBrush(RGB(0x00, 0x00, 0x00), 1), L"고딕", 30, str, 63 + 665 - wcslen(str), WINSIZEY - 117 + 195, 63 + 665 + 1, 523 + 195 + 50);
			}
			//살건지 물어보는 것 출력
			if (_isBuying)
			{
