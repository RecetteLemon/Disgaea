	...
	case 1:
		...
		for (int i = _changeNum; i < 8 + _changeNum; i++)
		{
			...
			if (_isBuyInfo)
			{
				...
				DIRECT2D->drawTextD2D(DIRECT2D->createBrush(RGB(0x7a, 0x7a, 0x7a), 1), L"고딕", 30, str, 63 + 330 - wcslen(str) * 20, 532 + 100, 63 + 330, 523 + 100 + 50);

				swprintf_s(str, L"%d", _item->getVItem()[_changeNum + (int)_buySlot].SP);
				DIRECT2D->drawTextD2D(DIRECT2D->createBrush(RGB(0x7a, 0x7a, 0x7a), 1), L"고딕", 30, str, 63 + 330 - wcslen(str) * 20, 532 + 130, 63 + 330, 523 + 130 + 50);
				
				swprintf_s(str, L"%d", _item->getVItem()[_changeNum + (int)_buySlot].Atk);
				DIRECT2D->drawTextD2D(DIRECT2D->createBrush(RGB(0x7a, 0x7a, 0x7a), 1), L"고딕", 30, str, 63 + 330 - wcslen(str) * 20, 532 + 165, 63 + 330, 523 + 165 + 50);
				
				swprintf_s(str, L"%d", _item->getVItem()[_changeNum + (int)_buySlot].Int);
				DIRECT2D->drawTextD2D(DIRECT2D->createBrush(RGB(0x7a, 0x7a, 0x7a), 1), L"고딕", 30, str, 63 + 330 - wcslen(str) * 20, 532 + 195, 63 + 330, 523 + 195 + 50);
				
				swprintf_s(str, L"%d", _item->getVItem()[_changeNum + (int)_buySlot].Def);
				DIRECT2D->drawTextD2D(DIRECT2D->createBrush(RGB(0x7a, 0x7a, 0x7a), 1), L"고딕", 30, str, 63 + 665 - wcslen(str) * 20, 532 + 165, 63 + 665, 523 + 165 + 50);
				
				swprintf_s(str, L"%d", _item->getVItem()[_changeNum + (int)_buySlot].Res);
				DIRECT2D->drawTextD2D(DIRECT2D->createBrush(RGB(0x7a, 0x7a, 0x7a), 1), L"고딕", 30, str, 63 + 665 - wcslen(str) * 20, 532 + 195, 63 + 665, 523 + 195 + 50);*/
