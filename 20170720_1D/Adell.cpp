...
void Adell::posSet(void)
{
	...
	_player.pos[PLAYER_POS_LB_LIFT]->setPlayFrame(arrRB_LIFT, 4, 0);
	_player.pos[PLAYER_POS_LB_LIFT]->setFPS(10);

	int arrLT_LIFT[] = { 60,61,62,63 };
	_player.pos[PLAYER_POS_LB_LIFT]->setPlayFrame(arrLT_LIFT, 4, 0);
	_player.pos[PLAYER_POS_LB_LIFT]->setFPS(10);

	int arrRT_LIFT[] = { 71,70,69,68 };
	_player.pos[PLAYER_POS_LB_LIFT]->setPlayFrame(arrRT_LIFT, 4, 0);
	_player.pos[PLAYER_POS_LB_LIFT]->setFPS(10);
	...
	_player.pos[PLAYER_POS_LB_SKILL]->setPlayFrame(arrLB_SKILL, 4, 0);
	_player.pos[PLAYER_POS_LB_SKILL]->setFPS(5);

	int arrRB_SKILL[] = { 131,130,129,128 };
	_player.pos[PLAYER_POS_RB_SKILL]->setPlayFrame(arrRB_SKILL, 4, 0);
	_player.pos[PLAYER_POS_RB_SKILL]->setFPS(5);

	int arrLT_SKILL[] = { 132,133,134,135 };
	_player.pos[PLAYER_POS_LT_SKILL]->setPlayFrame(arrLT_SKILL, 4, 0);
	_player.pos[PLAYER_POS_LT_SKILL]->setFPS(5);

	int arrRT_SKILL[] = { 143,142,141,140 };
	_player.pos[PLAYER_POS_RT_SKILL]->setPlayFrame(arrRT_SKILL, 4, 0);
