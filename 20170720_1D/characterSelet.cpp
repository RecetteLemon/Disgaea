...
void characterSelet::release()
{

}
void characterSelet::update()
{
...
void characterSelet::render()
{
	showstatUI();
}

void characterSelet::showstatUI()
{
