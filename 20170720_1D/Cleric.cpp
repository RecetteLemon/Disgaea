...
HRESULT Cleric::init(const wstring characterName,const wchar_t* imageName, int x, int y)
{
...
void Cleric::posSet(void)
{
	...
	_player.pos[PLAYER_POS_LB_THROW]->setPlayFrame(arrLB_LIFT, 4, 0);
	...
	int arrLB_SKILL[] = { 52 };
	_player.pos[PLAYER_POS_LB_SKILL]->setPlayFrame(arrLB_SKILL, 1, 0);


	int arrRB_SKILL[] = { 55 };
	_player.pos[PLAYER_POS_RB_SKILL]->setPlayFrame(arrRB_SKILL, 1, 0);


	int arrLT_SKILL[] = { 53 };
	_player.pos[PLAYER_POS_LT_SKILL]->setPlayFrame(arrLT_SKILL, 1, 0);
	

	int arrRT_SKILL[] = { 54 };
	_player.pos[PLAYER_POS_RT_SKILL]->setPlayFrame(arrRT_SKILL, 1, 0);
