...
void effectManager::addEffect(string effectName, const char* imageName, const WCHAR* fileName, int imageWidth, int imageHeight, int effectWidth, int effectHeight, int fps, float elapsedTime, int buffer)
{
	image* img;
